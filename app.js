...
// Carte GeoJSON intégrée directement dans app.js.
// Cela évite tout problème de chemin data/be.json sur GitHub Pages.
const EMBEDDED_GEOJSON = {
...
function fetchGeoJson() {
  return Promise.resolve(EMBEDDED_GEOJSON);
}
...
// Keep the simulation controls on the RIGHT of the map even if an older
// stylesheet in the repository has different positioning rules.
// This is intentionally injected from app.js so you only need to replace app.js.
function enforceTwoColumnLayout() {
  const style = document.createElement("style");
  style.id = "simulator-layout-fix";
  style.textContent = `
    .layout {
      display: grid !important;
      grid-template-columns: minmax(0, 1.45fr) minmax(360px, 0.75fr) !important;
      grid-template-areas: "map side" !important;
